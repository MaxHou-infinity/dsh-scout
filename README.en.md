...
- `scout_ingest`: batch-register collected research results (auto-infers source type and evidence level per URL; individual failures are isolated without aborting the batch).
